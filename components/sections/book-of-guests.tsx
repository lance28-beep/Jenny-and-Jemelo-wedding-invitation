    ...
    >
      ...
      <div className="relative">
        ...
        <div className="max-w-5xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          <div className="relative bg-[#F7F5F1]/95 backdrop-blur-md border border-[#F7E6CA]/80 rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-6 lg:p-8 shadow-[0_20px_60px_rgba(0,0,0,0.45)] overflow-hidden">
            
            {isLoading ? (
              <div className="flex items-center justify-center py-12 sm:py-16">
                <div className="flex flex-col items-center gap-3">
                  <Loader2 className="h-8 w-8 sm:h-10 sm:w-10 animate-spin text-[#D2A4A4]" />
              ...
              <div className="flex items-center justify-center py-12 sm:py-16">
                <div className="text-center">
                  <div className="bg-[#F0F0EE] w-12 h-12 sm:w-14 sm:h-14 rounded-full flex items-center justify-center mx-auto mb-3 shadow-md border border-[#F7E6CA]">
                    <Heart className="h-6 w-6 sm:h-7 sm:h-7 text-[#D2A4A4]" />
                  </div>
              ...
              <div className="space-y-2 sm:space-y-3 relative">
                {guests.map((guest, index) => (
                  <div
                    key={index}
                    className="group relative bg-white/70 backdrop-blur-sm rounded-md sm:rounded-lg p-2.5 sm:p-3 md:p-4 border border-[#F7E6CA]/80 hover:border-[#E9D5C3] transition-all duration-300 hover:shadow-[0_4px_20px_rgba(0,0,0,0.3)] hover:bg-white"
                  >
                    <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                      {/* Avatar */}
                      <div className="relative h-8 w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 flex-shrink-0">
                        <div className="h-full w-full rounded-full bg-[#D2A4A4] text-[#F0F0EE] flex items-center justify-center font-semibold shadow-md ring-2 ring-[#F7E6CA]/70 text-[10px] sm:text-xs md:text-sm">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-1.5 sm:gap-2">
                          <div className="flex-1 min-w-0">
                            ...
                            {guest.Email && guest.Email !== "Pending" && (
                              <div className="flex items-center text-[10px] sm:text-xs text-[#556457]">
                                <Mail className="h-2.5 w-2.5 sm:h-3 sm:w-3 mr-1 text-[#E0B4B1] flex-shrink-0" />
                          ...
                          <div className="flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
                            <User className="h-3 w-3 sm:h-3.5 sm:w-3.5 text-[#D2A4A4] flex-shrink-0" />
                            <span className={`${cormorant.className} inline-flex items-center justify-center px-2 sm:px-2.5 py-0.5 sm:py-1 bg-[#F0F0EE] text-[#243127] rounded-full text-[10px] sm:text-xs font-semibold border border-[#F7E6CA] whitespace-nowrap`}>
                        ...
                        {/* Message */}
                        {guest.Message && (
                          <div className="mt-2 sm:mt-3 pt-2 sm:pt-3 border-t border-[#F7E6CA]/60">
                            <div className="flex items-start gap-1.5 sm:gap-2">
                              <MessageSquare className="h-3 w-3 sm:h-3.5 sm:w-3.5 text-[#E0B4B1] flex-shrink-0 mt-0.5" />
