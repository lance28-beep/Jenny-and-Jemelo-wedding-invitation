  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-3 sm:px-5 lg:px-8">
        ...
        <div className="hidden md:block absolute left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-[#A4AD92]/40 via-[#848B69]/55 to-[#A4AD92]/40 -translate-x-1/2 pointer-events-none">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-1.5 h-1.5 rounded-full bg-[#F4F5F0]" />
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-1.5 h-1.5 rounded-full bg-[#F4F5F0]" />
        </div>

        {/* Mobile timeline line */}
        <div className="md:hidden absolute left-6 sm:left-7 top-0 bottom-0 w-0.5 bg-gradient-to-b from-[#A4AD92]/45 via-[#848B69]/60 to-[#A4AD92]/45 pointer-events-none" />
...
function TimelineCard({ event, Icon, mobile }: { event: TimelineEvent; Icon: TimelineIcon; mobile?: boolean }) {
  return (
    <div
      className={`rounded-lg sm:rounded-xl border border-[#A4AD92]/60 bg-white/90 backdrop-blur-sm shadow-md hover:shadow-lg transition-all duration-300 ${
    ...
    >
      <div className={`${mobile ? "space-y-2" : "space-y-3 md:space-y-4"}`}>
        ...
        <div className="flex items-center gap-1.5">
          <Clock
            className={`${mobile ? "w-3.5 h-3.5" : "w-4 h-4 md:w-5 md:h-5"} text-[#848B69] flex-shrink-0`}
          />
          <p
            className={`${mobile ? "text-[10px]" : "text-xs sm:text-sm md:text-base"} font-bold tracking-[0.15em] text-[#848B69] uppercase`}
          >
            {event.time}
          </p>
        </div>
        ...
        {event.location && (
          <div
            ...
            } border-t border-[#A4AD92]/70`}
          >
            <MapPin
              className={`${mobile ? "w-3 h-3" : "w-3.5 h-3.5 md:w-4 md:h-4"} text-[#848B69] mt-0.5 flex-shrink-0`}
            />
...
function IconBadge({
  ...
  return (
    <div
      ...
      } rounded-full border-2 border-[#A4AD92]/70 bg-gradient-to-br from-white to-[#F4F5F0] flex items-center justify-center shadow-md hover:scale-105 transition-transform duration-300`}
    >
      {imageSrc ? (
        <Image
          src={imageSrc}
