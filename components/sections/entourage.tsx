  ...
  const NameItem = ({
    ...
    return (
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-[#A4AD92]/35 to-transparent opacity-0 group-hover/item:opacity-100 transition-opacity duration-300 rounded-md" />
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-1/3 bg-gradient-to-b from-[#848B69]/92 via-[#A4AD92]/78 to-transparent" />
        <div className="absolute bottom-0 left-0 w-full h-1/3 bg-gradient-to-t from-[#848B69]/95 via-[#A4AD92]/72 to-transparent" />
        {/* Soft radial light in purple tones */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(164,173,146,0.28),transparent_55%)] opacity-90" />
        {/* Subtle diagonal wash of muted purple */}
        <div className="absolute inset-0 bg-gradient-to-br from-[#848B69]/24 via-transparent to-[#A4AD92]/12 mix-blend-soft-light" />
      </div>
      ...
      >
        ...
        <div className="relative bg-[#F4F5F0]/95 backdrop-blur-md rounded-xl sm:rounded-2xl overflow-hidden border border-[#A4AD92]/80 shadow-[0_20px_60px_rgba(132,139,105,0.45)] transition-all duration-500 group">
          {/* Card content */}
                ...
                return (
                  <div key={category}>
                    {categoryIndex > 0 && (
                      <div className="flex justify-center py-3 sm:py-4 md:py-5 mb-5 sm:mb-6 md:mb-8">
                        <div className="flex items-center gap-2 w-full max-w-md">
                          <div className="h-[1.5px] flex-1 bg-gradient-to-r from-transparent via-[#A4AD92]/50 to-[#A4AD92]"></div>
                          <div className="w-1.5 h-1.5 bg-[#A4AD92] rounded-full"></div>
                          <div className="h-[1.5px] flex-1 bg-gradient-to-l from-transparent via-[#A4AD92]/50 to-[#A4AD92]"></div>
                        </div>
                      </div>
                    )}
              ...
              {Object.keys(grouped).filter(cat => !ROLE_CATEGORY_ORDER.includes(cat) && cat !== "Other").map((category) => {
                ...
                return (
                  <div key={category}>
                    <div className="flex justify-center py-3 sm:py-4 md:py-5 mb-5 sm:mb-6 md:mb-8">
                      <div className="flex items-center gap-2 w-full max-w-md">
                        <div className="h-px flex-1 bg-gradient-to-r from-transparent via-[#A4AD92]/50 to-[#A4AD92]/70"></div>
                        <div className="flex items-center gap-1.5">
                          <div className="w-1 h-1 bg-[#A4AD92]/70 rounded-full" />
                          <div className="w-1.5 h-1.5 bg-[#848B69]/90 rounded-full" />
                          <div className="w-1 h-1 bg-[#A4AD92]/70 rounded-full" />
                        </div>
                        <div className="h-px flex-1 bg-gradient-to-l from-transparent via-[#A4AD92]/50 to-[#A4AD92]/70"></div>
                      </div>
                    </div>
                    <TwoColumnLayout singleTitle={category} centerContent={true}>
                      {(() => {
