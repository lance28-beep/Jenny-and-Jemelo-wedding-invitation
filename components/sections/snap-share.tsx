...
export function SnapShare() {
  ...
  const hashtags = [
    "#ANNforgettableDayWithJemelo",
    "#ToANNfinittyAndBeyondWithJemelo",
    "#InilaANNparaKayJemelo"
  ]
    ...
    >
      <div className="relative max-w-6xl mx-auto px-3 sm:px-6 md:px-8">
        ...
        <motion.div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-6 lg:gap-10" variants={staggerChildren} initial="initial" animate="animate">
          <motion.div
            className="p-[1.5px] rounded-xl sm:rounded-[22px] bg-gradient-to-br from-[#A4AD92]/50 via-[#848B69]/30 to-[#A4AD92]/50 h-full lg:order-1"
            variants={fadeInUp}
            whileHover={{ y: -2 }}
            transition={{ duration: 0.3 }}
          >
            <div className="bg-gradient-to-br from-[#A4AD92] to-[#848B69] rounded-lg sm:rounded-[20px] p-3 sm:p-5 md:p-8 shadow-xl border border-[#A4AD92]/40 h-full flex flex-col justify-start">
              <div className="flex flex-col w-full">
                ...
                <div className="grid grid-cols-2 gap-1.5 sm:gap-3 md:gap-4">
                  ...
                  >
                    <Image src="/mobile-background/couple (6).JPG" alt="Wedding moment 1" fill className="object-cover" />
                  </motion.div>
                  <motion.div
                    className="relative aspect-square rounded-lg sm:rounded-xl overflow-hidden shadow-md border-2 border-white/30 hover:border-white/50 transition-all"
                    whileHover={{ scale: 1.03 }}
                    transition={{ duration: 0.25 }}
                  >
                    <Image src="/desktop-background/couple (16).jpg" alt="Wedding moment 2" fill className="object-cover" />
                  </motion.div>
                  <motion.div
                    ...
                    transition={{ duration: 0.25 }}
                  >
                    <Image src="/desktop-background/couple (26).JPG" alt="Wedding moment 3" fill className="object-cover" />
                  </motion.div>
                </div>
          ...
          <motion.div className="space-y-3 sm:space-y-5 lg:space-y-6 h-full flex flex-col lg:order-2" variants={fadeInUp}>
            <div className="p-[1.5px] rounded-xl sm:rounded-[22px] bg-gradient-to-br from-[#A4AD92]/50 via-[#848B69]/30 to-[#A4AD92]/50 flex-1">
              <div className="bg-gradient-to-br from-[#A4AD92] to-[#848B69] rounded-lg sm:rounded-[20px] p-3 sm:p-5 md:p-8 shadow-xl border border-[#A4AD92]/40 text-center h-full flex flex-col">
                ...
                <div className="mx-auto inline-flex flex-col items-center bg-white/90 backdrop-blur-sm p-2.5 sm:p-5 md:p-7 rounded-xl sm:rounded-2xl shadow-md border border-[#A4AD92]/40 mb-3 sm:mb-4 flex-1 justify-center">
                  <div className="mb-2 sm:mb-3 p-1.5 sm:p-3 rounded-lg sm:rounded-xl bg-white border border-[#A4AD92]/30">
                    <div className="bg-white p-1.5 sm:p-3 rounded-lg shadow-sm border border-[#A4AD92]/30">
                      <QRCodeCanvas 
                        id="snapshare-qr" 
                        value={websiteUrl} 
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 sm:gap-2 mx-auto px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg bg-white text-[#848B69] border border-[#A4AD92]/40 shadow-md hover:shadow-lg hover:-translate-y-0.5 hover:bg-[#F4F5F0] transition-all duration-200 text-xs sm:text-sm font-semibold"
                  >
            ...
            <div className="bg-gradient-to-br from-[#A4AD92] to-[#848B69] rounded-lg sm:rounded-[20px] p-3 sm:p-5 md:p-7 shadow-xl border border-[#A4AD92]/40">
              ...
              <div className="space-y-2.5 sm:space-y-3 mb-3 sm:mb-4">
                {hashtags.map((hashtag, index) => (
                  <motion.div
                    key={index}
                    className="bg-white/90 backdrop-blur-sm rounded-lg sm:rounded-xl p-3 sm:p-4 border border-[#A4AD92]/40 shadow-sm hover:shadow-md transition-all duration-200"
                  ...
                  >
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-3">
                      <span className={`${cormorant.className} text-[#848B69] font-bold text-sm sm:text-base md:text-lg break-all flex-1 text-center sm:text-left`}>
                        {hashtag}
                      </span>
                      <button
                        onClick={() => copyHashtag(hashtag, index)}
                        className={`flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg bg-gradient-to-r from-[#848B69] to-[#A4AD92] text-white transition-all duration-200 shadow-md hover:shadow-lg hover:scale-105 border border-[#848B69]/50 whitespace-nowrap flex-shrink-0 ${
            ...
            {driveLink && (
              <div className="p-[1.5px] rounded-xl sm:rounded-[22px] bg-gradient-to-br from-[#A4AD92]/50 via-[#848B69]/30 to-[#A4AD92]/50">
                <div className="bg-gradient-to-br from-[#A4AD92] to-[#848B69] rounded-lg sm:rounded-[20px] p-3 sm:p-5 md:p-7 shadow-xl border border-[#A4AD92]/40 text-center">
                  ...
                  <div className="mx-auto inline-flex flex-col items-center bg-white/90 backdrop-blur-sm p-2.5 sm:p-5 rounded-xl sm:rounded-2xl shadow-md border border-[#A4AD92]/40 mb-3 sm:mb-4">
                    <div className="mb-2 sm:mb-3 p-1.5 sm:p-3 rounded-lg sm:rounded-xl bg-white border border-[#A4AD92]/30">
                      <div className="bg-white p-1.5 sm:p-3 rounded-lg shadow-sm border border-[#A4AD92]/30">
                        <QRCodeCanvas id="drive-qr" value={driveLink} size={isMobile ? 130 : 200} includeMargin className="bg-white" />
                      </div>
                    </div>
                    <p className={`${cormorant.className} text-[#848B69] text-xs sm:text-sm`}>📱 Scan with your camera app</p>
                  </div>
                  <div className="flex flex-col sm:flex-row justify-center gap-2 sm:gap-3">
                    <button
                      onClick={copyDriveLink}
                      className={`flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg bg-white text-[#848B69] border border-[#A4AD92]/40 shadow-sm hover:shadow-md hover:bg-[#F4F5F0] text-xs sm:text-sm transition-all ${
                    ...
                    <button
                      ...
                      className="flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg bg-white text-[#848B69] border border-[#A4AD92]/40 shadow-sm hover:shadow-md hover:bg-[#F4F5F0] text-xs sm:text-sm transition-all font-semibold"
                    >
                      <Download className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                      <span className={`${cormorant.className} tracking-[0.15em] sm:tracking-[0.18em] uppercase font-medium`}>Download QR</span>
                    </button>
