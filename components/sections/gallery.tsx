...
export function Gallery() {
  ...
  return (
    <Section
      id="gallery"
      className="relative bg-[#848B69] py-10 sm:py-12 md:py-16 lg:py-20 overflow-hidden"
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-1/2 bg-gradient-to-b from-[#848B69]/90 via-[#A4AD92]/70 to-transparent" />
        <div className="absolute bottom-0 left-0 w-full h-1/2 bg-gradient-to-t from-[#848B69]/95 via-[#A4AD92]/70 to-transparent" />
        {/* Lavender radial spotlight */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(164,173,146,0.3),transparent_55%)] opacity-90" />

        {/* Floating decorative circles with purple and sage colors */}
        <div className="absolute top-6 left-8 w-32 h-32 bg-[#A4AD92]/26 rounded-full blur-3xl animate-pulse-slow" />
        <div className="absolute top-16 right-12 w-24 h-24 bg-[#A4AD92]/26 rounded-full blur-2xl animate-pulse-slow" style={{ animationDelay: "1s" }} />
        <div className="absolute bottom-20 left-16 w-28 h-28 bg-[#F4F5F0]/22 rounded-full blur-3xl animate-pulse-slow" style={{ animationDelay: "2s" }} />
        <div className="absolute bottom-10 right-10 w-20 h-20 bg-[#848B69]/26 rounded-full blur-2xl animate-pulse-slow" style={{ animationDelay: "0.5s" }} />
      </div>
      ...
      <div className="relative z-10 text-center mb-8 sm:mb-10 md:mb-12 px-4">
        ...
        <div className="flex items-center justify-center gap-2 mt-6">
          <div className="w-8 sm:w-12 h-px bg-gradient-to-r from-transparent via-[#A4AD92]/80 to-transparent" />
          <motion.div
          ...
          />
          <div className="w-8 sm:w-12 h-px bg-gradient-to-l from-transparent via-[#A4AD92]/80 to-transparent" />
        </div>
      </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 sm:gap-3.5 md:gap-4.5">
                {galleryItems.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="absolute -inset-0.5 bg-gradient-to-br from-[#A4AD92]/45 via-[#A4AD92]/28 to-[#F4F5F0]/20 rounded-lg sm:rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-sm" />
                    ...
                    <div className="absolute top-2 right-2 bg-[#848B69]/90 backdrop-blur-sm rounded-full px-2 py-1 opacity-0 group-hover:opacity-100 transition-opacity duration-300 border border-[#A4AD92]/70">
      ...
      <div className="relative z-10 mt-8 sm:mt-10 md:mt-12 flex justify-center px-4">
        <motion.a
          ...
          style={{
            backgroundImage: "linear-gradient(135deg, #848B69, #A4AD92)",
            borderColor: "#F4F5F0",
            color: "#FFFFFF",
            boxShadow: "0 6px 26px rgba(132,139,105,0.45), 0 2px 10px rgba(164,173,146,0.6)",
          }}
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          ...
          whileTap={{ scale: 0.98 }}
          onMouseEnter={(e) => {
            e.currentTarget.style.backgroundImage = "linear-gradient(135deg, #A4AD92, #848B69)";
            e.currentTarget.style.borderColor = "#A4AD92";
            e.currentTarget.style.boxShadow = "0 10px 34px rgba(132,139,105,0.55), 0 4px 14px rgba(164,173,146,0.8)";
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.backgroundImage = "linear-gradient(135deg, #848B69, #A4AD92)";
            e.currentTarget.style.borderColor = "#F4F5F0";
            e.currentTarget.style.boxShadow = "0 6px 26px rgba(132,139,105,0.45), 0 2px 10px rgba(164,173,146,0.6)";
          }}
        >
          ...
          <div 
            className="absolute inset-0 bg-gradient-to-r from-transparent via-[#A4AD92]/40 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-700 transform -skew-x-12 -translate-x-full group-hover:translate-x-full"
          />
          {/* Pulsing glow effect */}
          <motion.div 
            className="absolute inset-0 bg-[#A4AD92]/25 rounded-lg sm:rounded-xl blur-xl -z-10"
            animate={{
              opacity: [0.3, 0.6, 0.3],
              scale: [1, 1.1, 1],
            }}
