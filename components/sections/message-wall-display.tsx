  ...
  if (loading) {
    return (
      <div className="space-y-2 sm:space-y-3 md:space-y-4 lg:space-y-6">
        {[1, 2, 3].map((i) => (
          <Card key={i} className="border-2 border-[#F7E6CA]/70 shadow-lg bg-white/85 backdrop-blur-md rounded-xl sm:rounded-2xl">
            <CardContent className="p-2.5 sm:p-3 md:p-4 lg:p-5">
              <div className="flex justify-between items-start mb-2 sm:mb-3 md:mb-4">
                <div className="flex items-center space-x-2 sm:space-x-3 md:space-x-4">
                  <Skeleton className="w-7 h-7 sm:w-8 sm:h-8 md:w-10 md:h-10 rounded-full bg-gradient-to-br from-[#D2A4A4]/35 via-[#E0B4B1]/30 to-[#F7E6CA]/30" />
              ...
              <Skeleton className="h-12 sm:h-14 md:h-16 w-full bg-gradient-to-r from-[#D2A4A4]/14 via-[#E0B4B1]/10 to-[#F7E6CA]/16 rounded-lg" />
            </CardContent>
          </Card>
        ))}
      </div>
    ...
    return (
      <div className="text-center py-6 sm:py-10 md:py-14 lg:py-16 xl:py-20 px-2 sm:px-4">
        <div className="relative inline-block mb-4 sm:mb-5 md:mb-6 lg:mb-8">
          <div className="absolute inset-0 bg-gradient-to-r from-[#D2A4A4]/45 to-[#E0B4B1]/30 rounded-full blur-xl scale-150 animate-pulse-slow" />
          <div className="relative w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 lg:w-18 lg:h-18 bg-gradient-to-br from-[#D2A4A4] via-[#E0B4B1] to-[#F7E6CA] rounded-full flex items-center justify-center mx-auto shadow-lg">
        ...
        <div className="mt-4 sm:mt-5 md:mt-6 lg:mt-8 flex justify-center">
          <div className="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-1.5 sm:py-2 bg-white/10 backdrop-blur-sm rounded-full border border-[#F7E6CA]/60">
            <Sparkles className="h-3 w-3 sm:h-4 sm:w-4 text-[#E9D5C3] animate-pulse" />
  ...
  return (
    <div className="space-y-2 sm:space-y-2.5 md:space-y-3 lg:space-y-4">
      {visibleMessages.map((msg, index) => (
        <Card
          key={index}
          className={`relative border-2 border-[#F7E6CA]/75 shadow-lg bg-white/88 backdrop-blur-md hover:shadow-2xl hover:border-[#E9D5C3] transition-all duration-500 group overflow-hidden transform rounded-xl sm:rounded-2xl hover:scale-[1.01] ${
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-[#F7E6CA]/18 via-transparent to-[#F0F0EE]/18 opacity-70 group-hover:opacity-95 transition-opacity duration-300" />
          <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#D2A4A4]/55 via-[#E0B4B1]/60 to-[#E9D5C3]/55 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left" />
          ...
          <CardContent className="relative p-2 sm:p-2.5 md:p-3 lg:p-3.5">
            <div className="flex justify-between items-start mb-1.5 sm:mb-2 md:mb-2.5">
              <div className="flex items-center space-x-1.5 sm:space-x-2 md:space-x-2.5">
                <div className="relative">
                  <div className="w-7 h-7 sm:w-9 sm:h-9 md:w-11 md:h-11 bg-[#D2A4A4] rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg ring-2 ring-white/70">
                  ...
                  {/* Subtle avatar glow */}
                  <div className="absolute -inset-1 rounded-full bg-[#D2A4A4]/30 blur-md opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10" />
                </div>
                <div className="min-w-0 flex-1">
                  <div className="flex items-baseline gap-1 sm:gap-1.5">
                    <h4 className="font-lora text-[#1F2420] text-xs sm:text-sm md:text-base font-semibold truncate group-hover:text-[#D2A4A4] transition-colors duration-300">
                      {msg.name}
                    </h4>
              ...
              <div className="flex items-center gap-1.5 sm:gap-2">
                <Heart className="h-3 w-3 sm:h-4 sm:w-4 md:h-5 md:w-5 text-[#D2A4A4]/80 fill-[#E9D5C3]/20 group-hover:fill-[#E9D5C3]/45 group-hover:text-[#D2A4A4] transition-all duration-300 group-hover:scale-110" />
                <Sparkles className="h-2.5 w-2.5 sm:h-3 sm:w-3 md:h-4 md:w-4 text-[#E9D5C3]/85 group-hover:text-[#F0F0EE] transition-all duration-300 group-hover:scale-110 group-hover:rotate-12" />
              </div>
            </div>
            
            <div className="relative">
              <span className="absolute -left-0.5 -top-0.5 sm:-left-1 sm:-top-1 md:-left-2 md:-top-2 text-xl sm:text-2xl md:text-4xl text-[#D2A4A4]/30 font-playfair group-hover:text-[#D2A4A4]/55 transition-all duration-300 group-hover:scale-110">
                "
              </span>
              ...
              <span className="absolute -right-0.5 -bottom-0.5 sm:-right-1 sm:-bottom-1 md:-right-2 md:-bottom-2 text-xl sm:text-2xl md:text-4xl text-[#E9D5C3]/40 font-playfair group-hover:text-[#E9D5C3]/70 transition-all duration-300 group-hover:scale-110">
                "
              </span>
            </div>
            ...
            <div className="mt-1.5 sm:mt-2 md:mt-3 flex items-center justify-between">
                <div className="flex items-center gap-0.5 sm:gap-1 text-[9px] sm:text-[10px] text-[#37413A]/65">
                  <div className="w-1 h-1 rounded-full bg-[#D2A4A4]/80" />
                  <div className="w-1 h-1 rounded-full bg-[#E0B4B1]/80" />
                  <div className="w-1 h-1 rounded-full bg-[#E9D5C3]/80" />
              </div>
                <div className="w-14 sm:w-16 h-0.5 bg-gradient-to-r from-transparent via-[#D2A4A4]/70 to-transparent group-hover:via-[#E9D5C3]/85 transition-all duration-300" />
            </div>
          </CardContent>
        </Card>
      ))}
